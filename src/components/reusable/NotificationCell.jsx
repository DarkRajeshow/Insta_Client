...
const NotificationCell = ({ notification }) => {
    ...
    return (
        <Link to={`${notificationType === "message" ? `/messages/${notification.relatedUser._id}` : "/posts"}`} className='flex items-center hover:bg-zinc-800 bg-zinc-800/20 rounded-lg my-1 justify-between w-full py-3 px-2 relative  cursor-pointer'>
